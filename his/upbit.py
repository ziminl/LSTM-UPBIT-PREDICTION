...
class Upbit(object):
        ...
        with requests.Session() as s:
            ...
            if authorization:
                ...
                if query_params is not None:
                    ...
                    url = '{0:s}?{1:s}'.format(url, query_string.decode('utf-8'))
    ...
    def get_candles_per_minutes(self, minute, market, to='', count=1):
    ...
    def get_candles_daily(self, market: object, to: object = '', count: object = 1) -> object:
        query_params = {'market': market,
                        'to': to,
                        'count': count}
    ...
    def place_order(self, market, side, volume=None, price=None, ord_type='limit'):
        query_params = {'market': market, 'side': side, 'ord_type': ord_type}
        if side == 'bid':
